...
export function Description() {
    return <div className='row'>
        <div className="col-12 col-sm-6">
            <h2>WHAT IS IT</h2>
            <ul>
                <li>Bored of jumping from navigator and weather apps to plan long trips by 🚗 or 🚲 or 🚶‍♂️? </li>
        ...
        <div className="col-12 col-sm-6">
            ...
            <ul>
                ...
                <li className={`mt-2 d-flex align-items-center gap-2 ${s.info}`}>
                    ...
                    <span>
                        map and directions are provided by <a href='https://developers.google.com/maps' target='_new' content='Link to Google Maps API'>Developer Google Maps</a>,
